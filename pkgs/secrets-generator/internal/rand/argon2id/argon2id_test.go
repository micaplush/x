...
func TestCreateHash(t *testing.T) {
	...
	hash1, err := CreateHash(rand.Reader, "pa$$word", DefaultParams)
	if err != nil {
		t.Fatal(err)
	}
	...
	hash2, err := CreateHash(rand.Reader, "pa$$word", DefaultParams)
	if err != nil {
		t.Fatal(err)
	}
...
func TestComparePasswordAndHash(t *testing.T) {
	hash, err := CreateHash(rand.Reader, "pa$$word", DefaultParams)
	if err != nil {
		t.Fatal(err)
	}
